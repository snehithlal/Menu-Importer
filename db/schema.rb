...
ActiveRecord::Schema[7.2].define(version: 2024_09_26_132549) do
  ...
  create_table "import_logs", force: :cascade do |t|
    ...
    t.index ["restaurant_id"], name: "index_import_logs_on_restaurant_id"
  end
  ...
  create_table "imports", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["restaurant_id"], name: "index_imports_on_restaurant_id"
  end
  ...
  add_foreign_key "import_logs", "restaurants"
  add_foreign_key "imports", "restaurants"
